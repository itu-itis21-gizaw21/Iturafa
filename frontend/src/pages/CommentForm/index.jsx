...
const CommentForm = (props) => {
    ...
    return (
        <WidgetWrapper p="0.6rem 0.5rem 0.1rem 0.2rem !important" m="0rem auto 0.5rem auto" width= {isNonMobileScreen ? "70%": "80%"}  onClick={handleTextAreaFocus} 
        >
            <FlexBetween>
             <InputBase
            ...
            ></Box>
             { commentArea &&(
            <FlexBetween width=  '100%' margin="1rem auto">
